...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const initialise = async () => {
      ...
      const pages =
        bookNode.current.querySelectorAll<HTMLElement>(".album-page");
      (
  ...
  return (
    <main className={`album-app ${ready ? "is-ready" : ""}`}>
      ...
      <section
        className="album-studio "
        aria-label="Interactive Milani anniversary album"
      >
        ...
        <div className="flipbook" ref={bookNode}>
          ...
          <article className="album-page">
            <div className="sheet founder-sheet">
              ...
              <div className="founder-portrait">
                <img
                  src="/demetrio.jpeg"
                  alt="Demetrio Milani, founder of the Milani Group"
                />
                <span>THE CHIEF / FAMILY ARCHIVE</span>
              </div>
              <div className="founder-copy">
                <p className="micro">A HUMBLE VISION</p>
                <h2>
                  A legacy begins
                  <br />
                  with <em>integrity.</em>
                </h2>
                <p>
                  Demetrio Milani built the Milani Group through hard work,
                  professional excellence and a deep commitment to every family
                  he served.
                </p>
                <blockquote>
                  “Built not only with tools,
                  <br />
                  but with integrity.”
                </blockquote>
              </div>
          ...
          <article className="album-page">
            <div className="sheet family-sheet">
              ...
              <div className="family-paper">
                <span>LINDA MILANI / FAMILY ARCHIVE</span>
                <p>
                  While Demetrio built the company in the field, Linda kept
                  everything behind the scenes moving—helping turn a growing
                  business into a lasting family legacy.
                </p>
                <b>
                  Bookkeeper · Secretary · Chauffeur
                  <br />
                  Business partner · Mother · Family anchor
                </b>
                <i>LM</i>
              </div>
          ...
          <article className="album-page">
            <div className="sheet craft-sheet">
              ...
              <div className="craft-head">
                <p className="micro">THE REPUTATION</p>
                <h2>
                  One home
                  <br />
                  at a time.
                ...
                <p>
                  Good service is quiet, exacting work. It lives in the details
                  nobody notices—until they matter.
                </p>
              </div>
          ...
          <article className="album-page">
            <div className="sheet legacy-sheet">
              ...
              <div className="legacy-head">
                <p>FAMILY LEADERSHIP</p>
                <h2>
                  One vision.
                  <br />
                  <em>Four voices.</em>
                </h2>
                <span>The next generation carries the values forward.</span>
              </div>
              <div className="family-portraits">
                ...
                <Portrait
                  src="/chris-milani.png"
                  name="Chris"
                  role="FAMILY LEADERSHIP"
                />
                <Portrait
                  src="/katrina-milani.png"
                  name="Katrina"
                  role="FAMILY LEADERSHIP"
                />
              </div>
          ...
          <article className="album-page">
            <div className="sheet today-sheet">
              ...
              <img
                ...
                src="/milani-team.jpeg"
                alt="The Milani team gathered together"
              />
              <div className="today-shade" />
              <div className="today-copy">
                <p>THE PEOPLE BEHIND THE NAME</p>
                <h2>
                  Hundreds
                  <br />
                  of people.
...
function PageMark({
  ...
  return (
    <div className={`page-mark ${light ? "light" : ""}`}>
      <b>{page}</b>
      <span>/ 10</span>
      <i>{label}</i>
    </div>
